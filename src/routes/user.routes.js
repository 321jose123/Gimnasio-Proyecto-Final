...
const { ValidateCardIdDelete, validateFingerprint, validateCardAddToUser } = require('../middlewares/validators/users.validators');
...
const {getUserCardId, deleteUsercard, addCardToUser} = require('../controllers/cards/card.controller');
